$('.btn-leavecomment').click(function(){
    ...
    $.post('user_addcommentpost.php',{comment:comment,postid:postid},function(data){
...
$('.btn-leavecomment-notreg').click(function(){
    var comment = $('#comment').val();
    var postid = $(this).attr('post-id');
    $.post('user_makecomment_topost_notreg.php',{postid:postid,comment:comment},function(data){
...
$('.btn-replycomment').click(function(){
    ...
    if(replycomment.length!=0 && replycomment!=" " && replycomment!="  " && replycomment!="   "){
        ...
        $.post('user_makereply_postcomment.php',{idcomment:idcomment,idsubcomment:idsubcomment,replycomment:replycomment},function(data){
...
$(document).ready(function(){
    ...
    setInterval(function(){
        ...
        $.post('ajax-chechnewpostcooments.php',{postid:thispostid,commentssort:commentssort,razvernut_all_comments:razvernut_all_comments, json_razvernut_subcoments:json_razvernut_subcoments, json_added_comments:json_added_comments},function(data){
...
function clickLikeListener(){
    $('.click_like').click(function(){
        ...
        $.post('user_makelike_topostcomment.php',{idcomment:idcomment,datatype:datatype},function(data){
