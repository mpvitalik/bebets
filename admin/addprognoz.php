...
<div class="container">
    <div class="row">
        <div class="col-md-8" >
            <a href="prognozi.php" style="font-size: 18px;">< Назад</a>
            ...
            <form role="form" action="<?=basename(__FILE__)?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_champ" id="id_champ" style="width:300px;">
                        ...
                        <?php foreach ($all_championats as $all_championat):?>
                            <option value="<?=$all_championat->getId()?>"><?=$all_championat->getNazva()?></option>
                        <?php endforeach;?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea cols="60" rows="1" name="matchnazva" id="matchnazva"></textarea>
                </div>
                <div>
